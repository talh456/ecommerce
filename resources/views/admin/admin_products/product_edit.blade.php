            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value={{$data->title}} class="form-control" name="title" id="category_name" placeholder="Enter Category Name">
                    @error('title')
             ...
             <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" value={{$data->price}} name="price" id="category_name" placeholder="Enter Category Name">
                @error('price')
                <p style="color:red">{{$message}}</p>
                @enderror
              </div>
